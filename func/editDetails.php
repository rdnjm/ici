...
<div class="container v-center">
	...
	<form class="form-horizontal" role="form" action='func/saveInfo.php' method='POST'>
    	<div class="form-group form-group-sm">
      		<label class="col-sm-2 control-label" for="lg">Employee Number: </label>
      		<div class="col-sm-3">
         		<input <?php echo "value='" . $_GET['empNum'] . "'"; ?> name='empNum' class = 'form-control'>
      		</div>
         
         	<label class="col-sm-2 control-label" for="sm">Date Employed:  </label>
      		<div class="col-sm-3">
        		<input <?php echo "value='" . $dateEmployed . "'"; ?> name='dateEmployed' class = 'form-control'>
    		</div>   
    	</div>
    	...
    	<div class="form-group form-group-sm">
      		...
      		<div class="col-sm-3">
         		<input <?php echo "value='" . $lastname . "'"; ?> name='lastName' class = 'form-control'>
      		</div>
        ...
        <div class="form-group form-group-sm">
      		...
      		<div class="col-sm-3">
       			<input <?php echo "value='" . $firstname . "'"; ?> name='firstName' class="form-control">
          	</div>
          	
          	<label class="col-sm-2 control-label" for="sm">Rate Per Hour:  </label>
      		<div class="col-sm-3">
        		<input <?php echo "value='" . $rate . "'"; ?> name='rate' class = 'form-control'>
    		</div>   
	    </div>
	    ...
	    <div class="form-group form-group-sm">
      		...
      		<div class="col-sm-3">
      			<input <?php echo "value='" . $middlename . "'"; ?> name='middleName' class="form-control">
          	</div>
        ...
        <div class="form-group form-group-sm">
    		...
    		<div class="col-sm-3">
      			<input name='tin'  class = "form-control"<?php echo "value='" .  $tin . "'"; ?>>
    		</div>   
    	</div>
	    ...
	    <div class="form-group form-group-sm">
            ...
            <div class="col-sm-1">
         	...
         	<label class="col-sm-2 control-label" for="sm">SSS Number:  </label>
      		<div class="col-sm-3">
       			<input name='sss' class = "form-control" <?php echo "value='" . $sss . "'"; ?>>
    		</div>   
    	</div>
	    ...
	    <div class="form-group form-group-sm">
    		<label class="col-sm-2 control-label" for="lg">Contact Number: </label>
         	...
         	<label class="col-sm-2 control-label" for="sm">PhilHealth:  </label>
      		<div class="col-sm-3">
       			<input name='philhealth' class = "form-control" <?php echo "value='" .  $philhealth . "'"; ?>>
    		</div>   
    	</div>
    	...
    	<input type='hidden' name='oldEmpNum' <?php echo "value='" . $_GET['empNum'] . "'"?>>
	<div align = "right">
